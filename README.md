...
[![Build Status](https://builds.gbif.org/job/hp-biodiversitatsdatenbank/badge/icon)](https://builds.gbif.org/job/hp-biodiversitatsdatenbank/lastBuild/console)
...
# GBIF Hosted Portal: biodiversitatsdatenbank

This Jekyll website, **[biodiversitatsdatenbank (Staging)](https://biodiversitatsdatenbank.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
